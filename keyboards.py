...
inline_kb_full.insert(InlineKeyboardButton("Inline в этом же чате", switch_inline_query_current_chat='Kotok lox'))
inline_kb_full.add(InlineKeyboardButton('henntaaai)))', url='http://www.xxxhentaigallery.com/'))
